...
class Strings
{
    ...
    private static function all(): array
    {
        return [
            ...
            'requires_postie_notice' => __('Soulsong HTML and Markdown Blocks for Postie requires the Postie plugin to be installed and active - it has no effect on its own.', 'html-md-blocks-for-postie'),

            // Settings page (src/Settings.php) - menu + page heading
            'menu_title'   => __('HTML & Markdown Blocks', 'html-md-blocks-for-postie'),
            'page_heading' => __('Soulsong HTML and Markdown Blocks for Postie', 'html-md-blocks-for-postie'),
